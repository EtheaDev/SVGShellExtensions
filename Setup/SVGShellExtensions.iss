...
ita.UninstallMessage=È stata rilevata una versione precedente di "SVG  Shell Extensions and SVG Text Editor". Il programma di disinstallazione verrà eseguito...
[Tasks]
